<template>
    ...
    <!-- 创建博客 -->
        ...
        <p class="msg">限30个字</p>
        <h3>内容简介</h3>
        <el-input type="textarea" v-model="description" :autosize="{ minRows: 2, maxRows: 4 }" placeholder="请输入内容"></el-input>
        <p class="msg">限30个字</p>
        <h3>文章内容</h3>
        <el-input type="textarea" v-model="content" :autosize="{ minRows: 4, maxRows: 30 }" placeholder="请输入内容"></el-input>
        <p class="msg">限30个字</p>
        <p>
            <label>是否展示到首页</label>
